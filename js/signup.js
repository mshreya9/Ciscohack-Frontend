...
window.onload = function () {
  ...
  document.getElementById("postotp").addEventListener("click", (e) => {
    ...
    fetch("https://pragati-one.herokuapp.com/auth/postotp", {
      method: "POST",
          ...
          Swal.fire({
            ...
            showLoaderOnConfirm: true,
              ...
              if(result.isConfirmed){
                ...
                fetch("https://pragati-one.herokuapp.com/auth/verifyphone", {
                  method: "POST",
                  headers: new Headers({ "content-type": "application/json" }),
                  body: JSON.stringify({
                    phoneNumber: Number("91" + document.getElementById("phone").value),
  ...
  document.getElementById("sub").addEventListener("click", function (e) {
    ...
    if (status.includes("false")) {
      ...
      fetch("https://pragati-one.herokuapp.com/auth/signup", {
        method: "POST",
        body: formData,
      })
        .then(function (response) {
