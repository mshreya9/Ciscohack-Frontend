...
document.getElementById("prodSearch").addEventListener("input", () => {
    fetch(
        "https://pragati-one.herokuapp.com/products/search?q=" +
...
fetch("https://pragati-one.herokuapp.com/products/getall", {
    method: "GET",
    headers: {
...
function registerInterest(event) {
    ...
    fetch("https://pragati-one.herokuapp.com/products/interested", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            Authorization: token,
